    ...
    <div className='bg-slate-200 shadow-md'>
        <div  className='max-w-6xl justify-between items-center p-3 flex  mx-auto'>
            <h1 className='text-xl font-extrabold sm:text-3xl flex-wrap'>
                ...
                <span cl
                assName='text-slate-700'>Estate</span>
            </h1>
        ...
        <ul className='flex items-centers gap-5'>
           ...
           {currentUser?(<Link to="/profile"><img className='rounded-full h-7 w-7 object-cover'
                src={currentUser.avatar}
                alt='profile'/></Link> ):(<Link to="/sign-in"> <li className='hover:underline text-slate-700'>Sign In</li></Link>)} 
        </ul>
        </div>
    </div>
  )
